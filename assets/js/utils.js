...
const TOOLS = {
    'webp-png': {
        id: 'webp-png',
        slug: 'webp-to-png',
        pageTitle: 'Secure WebP to PNG Converter | Architect Zero',
        pageDesc: 'Convert WebP to PNG locally. 100% Private. No Uploads.',
        label: 'Secure WebP-PNG',
        mimeInput: ['image/webp'],
        acceptAttr: 'image/webp',
        extOutput: '.png',
        uiText: 'Drag & Drop Confidential WebP Files',
        panelId: null,
    ...
    'png-jpg': {
        id: 'png-jpg',
        slug: 'png-to-jpg',
        pageTitle: 'Secure PNG to JPG Converter | Architect Zero',
        pageDesc: 'Convert PNG to JPG locally in browser. Zero Data Leaks.',
        label: 'Secure PNG-JPG',
        mimeInput: ['image/png'],
        acceptAttr: 'image/png',
        extOutput: '.jpg',
        uiText: 'Drag & Drop Confidential PNG Files',
        panelId: null,
    ...
    'jpg-png': {
        id: 'jpg-png',
        slug: 'jpg-to-png',
        pageTitle: 'Secure JPG to PNG Converter | Architect Zero',
        pageDesc: 'Convert JPG to PNG locally. Air-gap ready processing.',
        label: 'Secure JPG-PNG',
        mimeInput: ['image/jpeg'],
        acceptAttr: 'image/jpeg',
        extOutput: '.png',
        uiText: 'Drag & Drop Confidential JPG Files',
        panelId: null,
        processor: convertToPNG
    },
    'to-webp': {
        id: 'to-webp',
        slug: 'to-webp',
        pageTitle: 'Secure Image to WebP Converter | Architect Zero',
        pageDesc: 'Convert images to WebP locally. Save space securely.',
        label: 'Secure To WebP',
        mimeInput: ['image/jpeg', 'image/png'],
        acceptAttr: 'image/jpeg, image/png',
        extOutput: '.webp',
        uiText: 'Drag & Drop Images to convert to WebP',
        panelId: null,
    ...
    'jpg-pdf': {
        id: 'jpg-pdf',
        slug: 'jpg-to-pdf',
        pageTitle: 'Secure JPG to PDF | Architect Zero',
        pageDesc: 'Create PDFs from images in browser memory. Legal & Safe.',
        label: 'Secure JPG-PDF',
        mimeInput: ['image/jpeg'],
        acceptAttr: 'image/jpeg',
        extOutput: '.pdf',
        uiText: 'Drag & Drop JPGs for PDF Generation',
        panelId: null,
    ...
    'webp-pdf': {
        id: 'webp-pdf',
        slug: 'webp-to-pdf',
        pageTitle: 'Secure WebP to PDF | Architect Zero',
        pageDesc: 'Create PDFs from WebP locally. 100% Private.',
        label: 'Secure WebP-PDF',
        mimeInput: ['image/webp'],
        acceptAttr: 'image/webp',
        extOutput: '.pdf',
        uiText: 'Drag & Drop WebPs for PDF Generation',
        panelId: null,
    ...
    'jpg-compressor': {
        id: 'jpg-compressor',
        slug: 'compressor',
        pageTitle: 'Secure Image Compressor | Architect Zero',
        pageDesc: 'Compress images locally. Reduce size without server uploads.',
        label: 'Secure Compressor',
        mimeInput: ['image/jpeg', 'image/png'],
        acceptAttr: 'image/jpeg, image/png',
        extOutput: '.jpg',
        uiText: 'Drag & Drop Images to Compress',
    ...
    'image-resizer': {
        id: 'image-resizer',
        slug: 'resizer',
        pageTitle: 'Secure Image Resizer | Architect Zero',
        pageDesc: 'Resize images in browser RAM. Precise & Private.',
        label: 'Secure Resizer',
        mimeInput: ['image/jpeg', 'image/png', 'image/webp'],
        acceptAttr: 'image/*',
        extOutput: null,
        uiText: 'Drag & Drop Images to Resize',
        panelId: 'panelResize',
